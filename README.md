...
- 🚀 Share my knowledge with the developer community through teaching and mentoring
- 📚 Develop comprehensive learning resources for aspiring developers
...
- 🏛️ **[OFMBukavu](https://github.com/HermesOliho/OFMBukavu)**: Official institutional website for the Franciscan Brothers congregation (Laravel + Blade)
- 🏢 **[OSICR](https://github.com/HermesOliho/OSICR)**: Official website of OSICR organization (Laravel + Blade)
- 🌐 **[DankoonWebsite](https://github.com/HermesOliho/DankoonWebsite)**: Official website for Dankoon with Docker deployment (Laravel + Blade)
- 🤝 **[KingaConnect](https://github.com/HermesOliho/KingaConnect)**: Web platform for KINGA International organization (Laravel + Blade)
